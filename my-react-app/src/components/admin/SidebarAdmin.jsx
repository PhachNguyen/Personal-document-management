import { LayoutDashboard, Users, FileText, BarChart2, Settings, LogOut } from "lucide-react";
                ...
                <nav className="mt-4 space-y-1">
                    {menu.map(({ label, icon: Icon, path }) => (
                        <NavLink
                            ...
                            to={path}
                            className={({ isActive }) =>
                                `flex items-center gap-3 px-6 py-2 text-sm font-medium rounded-md transition-all duration-150 ${isActive
